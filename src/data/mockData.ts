...
export const INITIAL_STATIONS: GasStation[] = deduplicateStations([
  ...
  // ABUJA FCT (CNG Official Network)
  {
    ...
    stationNotice: 'Official CNG Station Group. Update gas availability and report live pump pressures here!',
    stationComments: [
      {
        id: 'st-c-wuse1',
        author: 'Adeola B.',
    ...
    reports: [
      {
        ...
        statusLabel: 'Full stock',
        waitMinutes: 4,
        comment: 'Just filled up. Pressure is strong at pump 2 (215 bar). Smooth flow, accredited station.',
        likes: 18,
    ...
    reports: [
      {
        ...
        statusLabel: 'Full stock',
        waitMinutes: 5,
        comment: 'BOVAS official CNG refuelling outlet. Attendants are polite and quick.',
        likes: 11,
      },
    ],
  },
  ...
  // LAGOS STATE (CNG Official Network)
  {
    id: 'nipco-nnpc-ikeja',
    ...
    reports: [
      {
        ...
        statusLabel: 'Full stock',
        waitMinutes: 8,
        comment: 'Strategic refuelling spot on Lagos-Ibadan expressway under national CNG program.',
        likes: 29,
      },
    ],
  },
