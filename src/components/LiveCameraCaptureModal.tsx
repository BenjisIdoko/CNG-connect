    ...
    <div className="fixed inset-0 z-50 bg-black flex flex-col justify-between p-4 font-['Plus_Jakarta_Sans',sans-serif] animate-fade-in">
      ...
      <div className="flex items-center justify-between text-white z-10 pt-2 pb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-[16px] text-emerald-300">{title}</span>
        </div>
        <div className="flex items-center gap-2">
          {stream && (
            <button
      ...
      <div className="relative flex-1 bg-slate-900 rounded-3xl overflow-hidden flex items-center justify-center border border-white/10 my-2">
        {cameraError ? (
          <div className="p-6 text-center text-rose-300 max-w-sm flex flex-col items-center">
            ...
            <button
              ...
              className="px-6 py-3.5 bg-[#00E676] hover:bg-emerald-400 text-[#004D40] font-extrabold text-[14.5px] rounded-full shadow-lg flex items-center gap-2 active:scale-95 transition-all"
            >
          ...
          <>
            ...
            <div className="absolute inset-8 border-2 border-emerald-400/40 rounded-2xl pointer-events-none flex flex-col justify-between p-4">
            ...
            <div className="absolute bottom-4 left-4 bg-black/70 backdrop-blur-md text-white text-[11px] font-bold px-3 py-1.5 rounded-full border border-emerald-400/40 flex items-center gap-2">
      ...
      <div className="flex items-center justify-center pt-2 pb-4 z-10">
        {!cameraError && stream && (
          <button
            ...
            className="w-20 h-20 rounded-full border-4 border-white bg-[#00E676] hover:bg-emerald-400 active:scale-90 transition-all flex items-center justify-center shadow-2xl disabled:opacity-50"
            aria-label="Take Live Snapshot"
          >
            <div className="w-14 h-14 rounded-full bg-white flex items-center justify-center text-[#004D40]">
