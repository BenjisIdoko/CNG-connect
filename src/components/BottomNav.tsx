...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="lg:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-[370px] frosted-glass-nav rounded-full p-2 px-3 shadow-[0_12px_36px_rgba(0,0,0,0.15)] border border-slate-200/80 flex items-center justify-between font-['Urbanist',sans-serif]">
      {/* Map Tab */}
      <button
