...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="lg:hidden fixed bottom-3 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-[380px] bg-white rounded-[28px] shadow-[0_10px_32px_rgba(31,41,35,0.18)] grid grid-cols-4 px-2 pb-2 pt-2">
      ...
      {TABS.map((tab) => {
        ...
        return (
          ...
          >
            ...
            <span
              className={`text-[11px] leading-none mt-1 transition-colors ${
